...
class DataDateWiseRepository
{
    ...
    public function getDataDateWiseClientSave(Request $request)
    {
        ...
        $data_new = [
            ...
            'long_index_long_short_percent' => $request['long_index_long_short_percent'],
            ...
            'option_index_buy_call_put_percentage' => $request['option_index_buy_call_put_percentage'],
            'option_index_call_short' => $request['option_index_call_short'],
            'option_index_put_short' => $request['option_index_put_short'],
            'option_index_short_call_put_percent' => $request['option_index_short_call_put_percent'],
